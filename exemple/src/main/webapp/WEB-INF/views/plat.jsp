...
<c:url var="addAction" value="/plat/add" ></c:url>

<form:form action="${addAction}" commandName="plat">
    <table>
        <c:if test="${!empty plat.name}">
            <tr>
                <td>
                    <form:label path="id">
    ...
    <table class="tg">
        ...
        <c:forEach items="${listplats}" var="plat">
            <tr>
                ...
                <td>${plat.name}</td>
                <td>${plat.country}</td>
                <td><a href="<c:url value='/edit/${plat.id}' />" >Edit</a></td>
                <td><a href="<c:url value='/remove/${plat.id}' />" >Delete</a></td>
            </tr>
        </c:forEach>
    </table>
</c:if>
