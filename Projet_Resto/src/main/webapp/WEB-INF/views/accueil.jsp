...
<body>
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <h5 class="header col s12 light">Maison du Hamburger depuis 20 ans. </br> Basé Ã  Brest, vous ne commanderez pas chez nous par hasard!</h5>
        </div>
        <div class="row center">
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">Votre commande prÃªte en moins de 15 minutes ! Livraison réalisé en moins de 30 minutes chrono Ã  partir du moment votre commande est passée. </p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Une équipe Ã  votre écoute</h5>

            <p class="light">Nous vous promettons des produits frais et de qualité. Car votre satisfactions sera notre plus grande réussite.</p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">Vous n'aurez jamais passé une commande aussi facilement et rapidement.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <footer class="page-footer teal">
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          ...
          <p class="grey-text text-lighten-4">Nous sommes une équipe d'étudiant qui avons réalisé ce projet dans l'optique d'un UE dans le cadre de notre formation de MASTER Technologie de l'Information et Ingénierie Logiciel.</p>
    ...
    <div class="footer-copyright">
      <div class="container">
      Site réalisé par <a class="brown-text text-lighten-3" href="google.com">A. GOMEZ - J. LEVESQUE - C. MARREC</a>
      </div>
    </div>
  </footer>
