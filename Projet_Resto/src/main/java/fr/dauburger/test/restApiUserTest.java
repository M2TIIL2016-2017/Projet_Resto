...
public class restApiUserTest {
	    ...
	    public static final String REST_SERVICE_URI = "http://localhost:8080/Dauburger/";
	    ...
	    private static void updateUser() {
	        ...
	        User user  = new User();
	        user.setNom("Sarah");
	        restTemplate.put(REST_SERVICE_URI+"/users/" + user.getId(), user);
	        System.out.println(user);
	    }
